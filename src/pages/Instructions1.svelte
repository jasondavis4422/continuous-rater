...
<script>
  ...
  const ratingInstruct =
    ...
    ratingType +
    "</strong> a video makes you feel by using your keyboard to control a rating box (which is demoed on the next page) throughout the video. <br><br> You may redo this HIT up to " +
    numOptions +
    " more times (you are provided with a different video each time). ";
