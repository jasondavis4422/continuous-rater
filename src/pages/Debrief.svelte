    ...
    <div class="form-box">
        <form name="mturk" action={postURL} method="POST">
            ...
            <p>
                ...
                <strong>repeat this HIT with a new video</strong>, please return
                to the Mechanical Turk worksite and accept again. There are {numOptions}
                videos left to watch. Thanks! <br />
            </p>
